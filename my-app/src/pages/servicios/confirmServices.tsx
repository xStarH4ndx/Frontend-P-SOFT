...
import { Container, Grid, Typography, Button, Paper, Divider, Avatar } from "@mui/material";
            ...
            <Paper sx={{ p: 3, mt: 3 }}>
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={5} sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                        <Typography variant="h6">{`Servicio: ${serviceData.servicio}`}</Typography>
                    ...
                    <Grid item xs={4} sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                        ...
                        <Divider sx={{ mb: 1 }} />
                        <Typography variant="h6" sx={{color:"#1d4ed8", mb: 2 }}>
                            {`Precio: ${serviceData.precio} CLP`}
                        </Typography>
                    </Grid>
                </Grid>
            </Paper>
